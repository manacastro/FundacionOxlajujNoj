      ...
      <Row>
        <Col xs='12' md='6'>
          <Row>
            <Col>
              <Row className=' mt-3'>
                <h1 className={style.titleStyle}>Contacto </h1>
              </Row>
              <Row>
              ...
              <Row>
                ...
                <a href='https://wa.link/u7lbgt' className={style.textStyle}>
                  502 41285119
                </a>
              </Row>
            </Col>
        ...
        {/* <Col xs='12' md='4'>
          ...
          <Row className='justify-content-md-center mt-3'>
            <a
              href='https://www.paypal.com/paypalme/13noj'
          ...
          <Row className='justify-content-md-center mt-3'>
            <a href='./proyectos' className={style.access}>
              Proyectos
            </a>
          </Row>
          <Row className='justify-content-md-center mt-3'>
            <a href='./cursos' className={style.access}>
              Cursos y webinar
            </a>
          </Row>
        </Col> */}
